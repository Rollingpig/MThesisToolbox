...
if __name__ == '__main__':
    ...
    # export_compare_table('processed data/pop-Interchange.csv', 'results/md-pop-interchange.csv', field='maxPop')
    # export_compare_table('processed data/trip-concourse.csv', 'results/md-trip-time-concourse.csv', field='Duration')
    # export_compare_table('processed data/trip-concourse.csv', 'results/md-los-concourse.csv', field='LOS Duration')
    # export_compare_table('processed data/trip-platform.csv', 'results/md-los-platform.csv', field='LOS Duration')
    export_compare_table('processed data/pop-mtr-concourse.csv', 'results/md-pop-concourse.csv', field='maxPop')